    ...
    render() {
        ...
        return (
            <div>
                ...
                <Navbar.Brand href="#home">Gading Shoes</Navbar.Brand>
                    ...
                    <Nav className="mr-auto">
                        ...
                        {this.props.email ?
                            <>
                                <Nav.Link>
                                    <Link to='/cart'>
                                        <p className="navLinkProperty">My Cart<Badge style={{padding: "5px", fontSize: "20px", marginLeft: "3px"}}  variant="warning"> {this.props.cart.length} </Badge></p>
                                    </Link>                        
                                </Nav.Link>
                                <Nav.Link>
                                    <Link to='/history'>
